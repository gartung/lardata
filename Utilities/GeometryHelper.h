...
/** \addtogroup LArUtil
    ...
    @{*/
#ifndef UTIL_GEOMETRYHELPER_H
#define UTIL_GEOMETRYHELPER_H

// Larsoft includes from lardata/Utilities:
#include "Utilities/LArProperties.h"
#include "Utilities/DetectorProperties.h"
#include "Utilities/UtilException.h"

// Larsoft include from Larcore/Geometry:
...
public:
     ...
     */
    void SelectPolygonHitList(const std::vector<Hit2D> &inputHits,
     ...
     */
    std::vector<size_t>  OrderPolygonEdges( std::vector<const Hit2D*> ordered_hits ,
